...
export const CHANGE_PASSWORD = `${BASE_URL}${USERS}/change_password`
...
export const GET_RATE_LINK = `${BASE_URL}${RATES}/`
...
export const SET_MOOD = `${BASE_URL}${MOODS}/set_user_mood`
